            ...
            <div class="col-md-12 col-lg-12">
                <div class="card shadow-sm">
                    <div class="card-header bg-light shadow-sm">
                        <h4 class="card-title">Data Pejabat Penanda Tangan</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
    ...
    <div class="modal fade" id="tambah">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?= site_url('pejabat/add') ?>" method="post">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="nama_pejabat">Nama</label>
                            <input type="text" name="nama_pejabat" class="form-control" placeholder="Masukan Nama">
                        </div>
                        <div class="form-group">
    ...
    <?php foreach ($pejabat as $data) { ?>
        <div class="modal fade" id="edit<?= $data['id']; ?>">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editTitle">Edit Pejabat Penanda Tangan</h5>
                        <button type="button" class="close" data-dismiss="modal">
                            <i class="anticon anticon-close"></i>
                        </button>
                    </div>
                    <form action="<?= site_url('pejabat/' . $data['id'] . '/edit') ?>" method="post">
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="nama_pejabat">Nama</label>
                                <input type="text" name="nama_pejabat" value="<?= $data['nama_pejabat'] ?>" class="form-control" placeholder="Masukan Nama">
                            </div>
                            <div class="form-group">
                                <label for="nip">NIP</label>
                                <input type="text" name="nip" value="<?= $data['nip'] ?>" class="form-control" placeholder="Masukan NIP">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
    ...
    <?php foreach ($pejabat as $data) { ?>
        <div class="modal fade" id="delete<?= $data['id']; ?>">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteTitle">Hapus Pejabat Penanda Tangan</h5>
                        <button type="button" class="close" data-dismiss="modal">
                            <i class="anticon anticon-close"></i>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="<?= site_url('pejabat/' . $data['id']) ?>" method="post">
                            <div class="text-center">
                                <i class="fas fa-exclamation-circle fa-xl" style="font-size:100px;"></i><br><br>
                                <p>Apakah anda yakin ingin menghapus Pejabat Penanda Tangan <br><b><?= $data['nama_pejabat'] ?><br><?= $data['nip'] ?></b></p><br>
                            </div>
                            <div class="text-center">
